...
object NavieBayes_ME {
  def main(args: Array[String]): Unit = {
    ...
    val navieBayes = new NaiveBayes().setModelType("multinomial")

    val pipeline = new Pipeline().setStages(Array(regexTokenizer, hashingTF, navieBayes))
