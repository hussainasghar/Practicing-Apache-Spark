...
class Classifier(lang: String) {
  ...
  private var _wcount       = mutable.HashMap[Pair[String, String], Int]()    // [[category, word], count]
  private var _ccount       = mutable.HashMap[String, Int]()                  // [category, count]
  private var _probs        = mutable.HashMap[String, Double]()               // [category, probability]
